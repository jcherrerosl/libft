...
SRCS = 	ft_atoi.c     ft_isalpha.c  ft_itoa.c    ft_memmove.c     ft_putnbr_fd.c  ft_strdup.c  \
	...
	ft_calloc.c   	ft_isdigit.c  	ft_memcmp.c 	ft_putchar_fd.c  ft_strjoin.c  \
	ft_strmapi.c  	ft_strtrim.c  	ft_isalnum.c  	ft_isprint.c  	 ft_memcpy.c  ft_putendl_fd.c  ft_strchr.c \
